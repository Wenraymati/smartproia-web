...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description: "Bot de WhatsApp con inteligencia artificial para negocios. Atiende clientes, califica leads y cierra ventas 24/7. Setup en 7 días.",
      brand: { "@type": "Brand", name: "SmartProIA" },
      offers: [
        {
          "@type": "Offer",
          name: "Bot WhatsApp IA — Mantenimiento mensual",
          price: "99",
          priceCurrency: "USD",
          priceValidUntil: "2027-01-01",
          availability: "https://schema.org/InStock",
          url: "https://smartproia.com/pricing",
          description: "Mantenimiento mensual recurrente. Setup inicial $499 USD (pago único).",
        },
      ],
    },
  ],
